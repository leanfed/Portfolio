function animationHome() {
  ...
  document.querySelector(".contP1").style.animation = "animate 3s linear infinite, rotate ease 2s backwards";
  document.querySelector(".contP2").style.animation = "animate 3s linear infinite, rotate ease 2s backwards";
  document.querySelector(".contP3").style.animation = "animate 3s linear infinite, rotate ease 2s backwards";
    ...
    function countdown() {
      if (timeLeft == -1) {
        ...
        if (timeLeft == 8) {
          ...
          document.querySelector(".contP1").style.animation = "animate 3s linear infinite, -rotate ease 1s backwards";
          document.querySelector(".contP2").style.animation = "animate 3s linear infinite, -rotate ease 1s backwards";
          document.querySelector(".contP3").style.animation = "animate 3s linear infinite, -rotate ease 1s backwards";
        }
        timeLeft--;
      }
    }
